function getInfoFnNew(a, b, d) {
    $.ajax({
        ...
        complete: function(c) {
            ...
            $("#info" + b).attr("data-content", '<div class="row pull-right"><div class="col-lg-12 text-center"><a  href="#" class="close" data-dismiss="alert">&times;</a></div></div><div><p style="">' + c.main_text + "</p></div>");
            $("#info" +
                b).popover({
                html: !0
            });
...
function addWarenkorb() {
    ...
    $.ajax({
        ...
        data: {
            ...
            bereich: !0,
            wk: !0,
            img: obj_konfig.basket_img_plenty
        },
        complete: function(a) {
            ...
            dataLayer.push({
                event: "configurator",
                configuratorType: "schiebetuer-pvc-gealan",
...
function getMinMaxRollladen(a, b) {
    var d = [];
    $.ajax({
        ...
        async: !1,
        complete: function(c) {
            d = jQuery.parseJSON(c.responseText)
        },
        beforeSend: function() {}
    });
    return d
